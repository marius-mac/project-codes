      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-8 mx-auto text-center">
            <h5 class="section-heading text-white">Jūsų asmeninio ar įmonės kompiuterio remontas</h5>
            <hr class="light">
        ...
        <div class="row">
          <div class="col-lg-12 text-center">
            <h5 class="section-heading">Kompiuterinių sistemų gedimo nustatymas </h5>
              <p>Pirminis vertinimas - apžiūra;
                  Išvados ir rekomendacijos (jeigu taip pageidaujama);
                  įrenginių tikrinimas su specializuota laboratorine įranga;</p>
            <hr class="primary">
          </div>
        </div>
      </div>
