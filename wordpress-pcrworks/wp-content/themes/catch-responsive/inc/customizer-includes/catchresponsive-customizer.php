...
function catchresponsive_customize_register( $wp_customize ) {
	...
	$wp_customize->add_control( 'catchresponsive_theme_options[color_scheme]', array(
		'choices'  => catchresponsive_color_schemes(),
...
function catchresponsive_customize_preview() {
	wp_enqueue_script( 'catchresponsive_customizer', trailingslashit( esc_url ( get_template_directory_uri() ) ) . 'js/catchresponsive-customizer.min.js', array( 'customize-preview' ), '20120827', true );
...
function catchresponsive_customize_scripts() {
	wp_enqueue_script( 'catchresponsive_customizer_custom', trailingslashit( esc_url ( get_template_directory_uri() ) ) . 'js/catchresponsive-customizer-custom-scripts.min.js', array( 'customize-controls', 'iris', 'underscore', 'wp-util' ), '20150630', true );
