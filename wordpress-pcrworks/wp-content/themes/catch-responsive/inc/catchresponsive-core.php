...
function catchresponsive_enqueue_metabox_scripts() {
    //Scripts
	wp_enqueue_script( 'catchresponsive-metabox', trailingslashit( esc_url ( get_template_directory_uri() ) ) . 'js/catchresponsive-metabox.min.js', array( 'jquery', 'jquery-ui-tabs' ), '2013-10-05' );

	//CSS Styles
	wp_enqueue_style( 'catchresponsive-metabox-tabs', trailingslashit( esc_url ( get_template_directory_uri() ) ) . 'css/catchresponsive-metabox-tabs.css' );
}
