			...
			<div class="widget-wrap">
            	<h4 class="widget-title"><?php _e( 'Primary Sidebar Widget Area', 'catch-responsive' ); ?></h4>
       			...
       			<div class="textwidget">
               		...
               		<p><?php printf( __( 'By default it will load Search and Archives widgets as shown below. You can add widget to this area by visiting your <a href="%s">Widgets Panel</a> which will replace default widgets.', 'catch-responsive' ), esc_url( admin_url( 'widgets.php' ) ) ); ?></p>
             	</div>
       		</div><!-- .widget-wrap -->
